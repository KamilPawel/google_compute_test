<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-green-800">
  <div class="mx-auto max-w-screen-xl text-center">
    <a
      href="#"
      class="flex justify-center items-center text-2xl font-semibold text-green-900 dark:text-white"
    >
      <svg
        class="mr-2 h-8"
        viewBox="0 0 33 33"
    ...
    <p class="my-6 text-green-500 dark:text-green-400">
      Open-source library of over 400+ web components and interactive elements
      built for better web.
    </p>
    <ul
      class="flex flex-wrap justify-center items-center gap-3 mb-6 text-green-900 dark:text-white"
    >
      <li>
    ...
    <span class="text-sm text-green-500 sm:text-center dark:text-green-400"
      >© 2024 <a href="#" class="hover:underline">Flowbite™</a>. All Rights
      Reserved.</span
    >
  </div>
</footer>
