<section class="bg-white dark:bg-green-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <div class="max-w-screen-md mb-8 lg:mb-16">
      <h2
        class="mb-4 text-4xl tracking-tight font-extrabold text-green-900 dark:text-white"
      >
        Designed for business teams like yours
      </h2>
      <p class="text-green-500 sm:text-xl dark:text-green-400">
    ...
    >
      <div>
        ...
        >
          <svg
            class="w-5 h-5 text-green-600 lg:w-6 lg:h-6 dark:text-green-300"
            fill="currentColor"
            viewBox="0 0 20 20"
